  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        <div id="main-content" className="container mx-auto flex flex-col items-center px-4 py-16 sm:py-24 bg-muted/20 rounded-lg my-8">
            <h2 className="text-3xl font-bold text-center mb-4 text-gray-200">Welcome to the future of learning.</h2>
